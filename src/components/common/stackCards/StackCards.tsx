  ...
  return (
    <div ref={containerRef}>
      {children.map((child, index) => (
        <div
          key={index}
          className={`card sticky top-20 mx-auto max-w-[1024px] transform overflow-hidden rounded-xl shadow-[0px_0px_3px_0px_rgba(0,_0,_0,_0.1)] transition-transform duration-100 sm576:px-10 sm576:py-6 md:gap-10 lg:px-20 lg:py-10 ${
            index % 2 === 0

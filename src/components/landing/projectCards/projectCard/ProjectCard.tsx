...
export const ProjectCard = ({
  ...
  return (
    <div className="flex h-full max-h-screen justify-center overflow-hidden sm576:justify-start sm576:px-10 sm576:py-6 md:py-10 lg:gap-10 lg:px-20  h-full w-full bg-gray-800 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30">
      <AnimateInView
      ...
      <AnimateInView
        ...
        className="z-[2] w-full grow-0 overflow-y-auto bg-opacity-80 px-6 pt-6 opacity-0 transition-opacity duration-1000 ease-in-out bg-opacity-variable sm576:bg-transparent sm576:pt-2 sm576:text-white sm576:opacity-100 md:px-10"
      >
        ...
        <div className="h-md:sm:block mt-6 hidden">{description}</div>
